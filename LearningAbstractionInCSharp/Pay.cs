namespace LearningAbstractionInCSharp
{
    ...
    public class PayBill : Pay
    {
        ...
        public void Display()
        {
            Console.WriteLine("The output Mara was able to pay for GradeOne is: {0}", GradeOne);
            Console.WriteLine("The output Mara was able to pay for GradeTwo is: {0}", GradeTwo);
        }
    }
}
